...
public class dataTableStepDef {
	...
	public void enter_following_data(DataTable table) throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"registerForm\"]/div[1]/div[2]/input")).sendKeys(data.get(0));
		driver.findElement(By.xpath("//*[@id=\"registerForm\"]/div[1]/div[3]/input")).sendKeys(data.get(1));
		Thread.sleep(2000);
	}
}
